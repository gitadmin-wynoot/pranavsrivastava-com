...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/projects/signal`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/projects/signal/uncertainty`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
