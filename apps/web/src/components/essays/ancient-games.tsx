...
const GAMES: Game[] = [
  ...
  },
  {
    ...
    name: "Ashtāpada",
    place: "India",
    age: "pre-chess, 2,000+ years",
    accent: "border-sky-500/40 bg-sky-500/5",
    how: "An 8×8 board — ashta-pada, 'eight feet' — for an ancient race game, in use long before anyone set a war-game called chaturanga on top of it.",
    delight: "So the humble 8×8 grid every chessboard inherits began life in India as its own game — the quiet grandparent of the very squares Kasparov and Deep Blue went to war over.",
  },
  {
    emoji: "🐚",
    name: "Chaupar (Chausar)",
    place: "India",
    age: "ancient; epic-old",
    accent: "border-rose-500/40 bg-rose-500/5",
    how: "A cross-shaped cloth, cowrie shells thrown for dice, a dash to bring your pieces safely home — the ancestor of Pachisi, and so of the Ludo in your cupboard.",
    delight: "It belongs to the dice tradition behind the Mahābhārata's most catastrophic scene — a rigged game in which a king bets his kingdom, his brothers, himself and his wife, and loses the lot. Mughal emperors later played it life-size, with people as the pieces. Not always a low-stakes evening.",
  },
  {
    emoji: "🎯",
    name: "Backgammon",
