...
- Typed decisions with Jev and Laya: where a fast, cheap decision model can cut LLM cost, and where it should not be used
- Ten named harness patterns (Tool Gateway, Circuit Breaker, Shadow Evaluation Harness and more) for making all of the above dependable
