...
roadmap:
  - title: "Building a Personal AI OS"
    blurb: "The blueprint — memory, agents, tools, knowledge, and a public surface that's yours, not a chatbot's."
  - title: "Memory & Knowledge for Your AI"
    blurb: "Giving your system a second brain: what to remember, how to retrieve it, and how it gets better over time."
  - title: "Agents, Tools & the Daily Loop"
    blurb: "Wiring MCP tools and scheduled agents that do real work while you sleep — with observability you trust."
---
