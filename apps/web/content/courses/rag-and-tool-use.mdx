...
<Diagram title="The RAG pipeline" caption="Retrieve the right passages, then let the model answer from them">
...
```
  ...
  1. SEARCH your documents for relevant passages
       |
       v
  2. RETRIEVE the top few:  "...refunds within 30 days..."
       |
       v
  3. GIVE them to the model along with the question
       |
       v
  4. ANSWER from those passages, citing the source
       "Refunds are accepted within 30 days [Policy 4.2]."
```
