...
The specific artefact is a checkpointer. The idea underneath it is bigger: how you give a stateless, time-boxed function a memory — the ticket-notes trick, generalised — so it behaves like a reliable process instead of starting from scratch every single time. That pattern shows up well beyond agents.
</Callout>
...
The approval side of this is pattern 3 in [Agentic AI Harness Patterns](/courses/agentic-harness-patterns/03-the-approval-gate).
