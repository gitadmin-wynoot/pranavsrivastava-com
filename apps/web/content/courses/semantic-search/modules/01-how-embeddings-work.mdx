...
<Figure name="vectors-space" caption="Each piece of text becomes a point. Similar meanings sit close; unrelated ones sit far apart. (Real embeddings use hundreds of dimensions — shown here in 2D.)" />
