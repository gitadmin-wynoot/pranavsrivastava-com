...
**Go further:** [The Approval Gate](/courses/agentic-harness-patterns/03-the-approval-gate) and [The Permission Boundary](/courses/agentic-harness-patterns/02-the-permission-boundary) cover where to put the pause and how to limit what a fooled agent can do.
