...
<Diagram title="Embeddings place meaning in space" caption="Similar words cluster; relationships become directions">
...
```
  ...
  Similar things cluster. Famously: king - man + woman ≈ queen.
```
